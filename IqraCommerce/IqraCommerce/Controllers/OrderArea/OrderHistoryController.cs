...
{
    public class OrderHistoryController : AppDropDownController<OrderHistory, OrderHistoryModel>
    {
        OrderHistoryService ___service;
        public OrderHistoryController()
        {
            service = __service = ___service = new OrderHistoryService();
        }
    }
}
