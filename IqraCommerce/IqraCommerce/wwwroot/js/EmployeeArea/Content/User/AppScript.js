...
(function () {
    ...
    function SetCounterAccess(model) {
        Global.Add({
            model: model,
            name: 'SetCounterAccess',
            url: '/Content/IqraPharmacy/EmployeeArea/Content/User/AddCounterAccess.js',
        });
    };
    function onAdd() {
    ...
    Global.List.Bind({
        ...
        Grid: {
            elm: $('#grid'),
            columns: [
                { field: 'Id', selected: false, Add: false},
                ...
                { field: 'MaxSaleDiscount', title: 'Max Sale Discount' },
                { field: 'DesignationSalary', Add: false, add: {datatype:'int'} },
            ...
            Actions: [{
                ...
                click: SetCounterAccess,
                html: '<span class="hide_on_mobile icon_container" title="Set Counter Access" style="margin-right: 5px;"><span class="glyphicon glyphicon-plus-sign"></span></span>'
            }]
        },
