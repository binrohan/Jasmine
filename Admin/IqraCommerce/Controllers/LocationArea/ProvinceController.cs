...
{
    public class ProvinceController : AppDropDownController<Province, ProvinceModel>
    {
        ProvinceService ___service;
        public ProvinceController()
        {
            service = __service = ___service = new ProvinceService();
        }
    }
}
