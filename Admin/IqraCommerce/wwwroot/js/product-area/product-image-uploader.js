var Controller = new function () {
    var that = this, view, options, formModel = {}, oldTitle = document.title, IsNew = true, windowModel, formInputs, imgModel,referenceId;
    ...
    this.Show = function (opts) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/templates/file-uploader.html', function (response) {
