...
namespace App.Setup.Connection
{
    public class Connection
    {
        ...
        public static string ConnectionString = "data source=DESKTOP-2T4KNKA;initial catalog=Jasmine;persist security info=True;user id=sa;password=123;MultipleActiveResultSets=True";
